...
local on_attach = function(client, bufnr)
  ...
  -- bufmap('gd', '<cmd>lua require("goto-preview").goto_preview_definition()<cr>')
  bufmap('gD', '<cmd>lua vim.lsp.buf.declaration()<CR>')
  bufmap('gr', '<cmd>Telescope lsp_references<CR>')
  -- bufmap('gr', '<cmd>lua require("goto-preview").goto_preview_references()<CR>')
  bufmap(',lt', '<cmd>Telescope lsp_type_definitions<CR>')
  -- bufmap(',lt', '<cmd>lua require("goto-preview").goto_preview_type_definition()<CR>')
  bufmap(',lr', '<cmd>lua vim.lsp.buf.rename()<CR>')
  bufmap(',li', '<cmd>Telescope lsp_implementations<CR>')
  -- bufmap(',li', '<cmd>lua require("goto-preview").goto_preview_implementation()<CR>')
  ...
  -- bufmap(',lc', '<cmd>lua require("goto-preview").close_all_win()<CR>')
